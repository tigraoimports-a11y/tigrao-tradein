...
export async function fetchConfig(): Promise<AppConfig> {
  ...
  return {
    ...
    bonusGarantiaAte3m: parseNumber(configMap["Bonus garantia ate 3 meses"] || "200"),
    bonusGarantia3a6m: parseNumber(configMap["Bonus garantia 3 a 6 meses"] || "300"),
    bonusGarantia6mMais: parseNumber(configMap["Bonus garantia 6 meses ou mais"] || "400"),
  };
}
